...
import micimgfour from '../images/micimgfour.jpg'
import designimg2 from '../images/designimg2.jpg'
import writingimg from '../images/writingimg.jpg'
import artimg from '../images/artimg.jpg'
import head from '../images/Direction.jpg'
...
const LowerArea = () => {
  return (
    ...
    <div className='lowerarea'>
        <Typography color='white' fontSize='50px' fontFamily='serif' align='center' className='textdomain'>Explore our Domains <img src={head} height='80px' width='80px'/></Typography>

        <div className="domains">
        
        <img className='micimg' src={micimgfour}/>
        ...
        <img className='designimg' src={designimg2}/>

        <img className='writingimg' src={writingimg}/>
        ...
        <img className='artimg' src={artimg}/>
